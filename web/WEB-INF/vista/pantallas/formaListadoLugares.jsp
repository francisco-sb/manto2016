  ...
  function EliminarLugar(strLugarName){
    ...
    <table cellpadding="0" cellspacing="0" width="60%" border="0">
        ...
        <tr align="center" bgcolor="#CCCCCC">
         ...
         <td style="border-right-style:solid; border-left-style:solid; border-width:1px; border-color:#000000;"><b><fmt:message key="formaListadoLugares.etiqueta.latitud" /></b></td>
         <td style="border-right-style:solid; border-left-style:solid; border-width:1px; border-color:#000000;"><b><fmt:message key="formaListadoLugares.etiqueta.longitud" /></b></td>
