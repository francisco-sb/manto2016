...
<script language="javascript" type="text/javascript">
  ...
  function EliminarCiudad(strCiudadName){
    return confirm("¿Desea eliminar la ciudad '" + strCiudadName + "'?")
  }
    ...
    <table cellpadding="0" cellspacing="0" width="60%" border="0">
        ...
        <tr bgcolor="#CCCCCC">
         ...
         <td style="border-right-style:solid; border-left-style:solid; border-width:1px; border-color:#000000;"><b><fmt:message key="formaListadoCiudades.etiqueta.descripcion" /></b></td>
        ...
        <c:forEach var="ciudad" items="${formaListadoCiudades.ciudades}">
            <tr>
                ...
                <td align="left" width="60%"><c:out value="${ciudad.descripcion}"/></td>
