...
<script language="javascript" type="text/javascript">
  ...
  function EliminarRecomendacion(strRecomendacionName){
    return confirm("¿Desea eliminar la recomendacion '" + strRecomendacionName + "'?")
  }
    ...
    <table cellpadding="0" cellspacing="0" width="60%" border="0">
        ...
        <tr align="center" bgcolor="#CCCCCC">
         ...
         <td style="border-right-style:solid; border-left-style:solid; border-width:1px; border-color:#000000;"><b><fmt:message key="formaListadoRecomendaciones.etiqueta.comentario" /></b></td>
