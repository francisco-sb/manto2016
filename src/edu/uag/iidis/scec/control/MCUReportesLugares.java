...
public final class MCUReportesLugares
        extends MappingDispatchAction {

    private Log log = LogFactory.getLog(MCURegistrarUsuario.class);


    public ActionForward solicitarReportesLugares(
        ...
        if (log.isDebugEnabled()) {
            log.debug(">solicitarReportesLugares");
        }
        ...
        FormaReporteLugares forma = (FormaReporteLugares)form;
